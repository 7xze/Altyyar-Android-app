...
import com.altayyar.app.presentation.ui.feature.preference.PreferencesFragment.ReadingOrder.NEWEST_FIRST
import com.altayyar.app.presentation.ui.feature.preference.PreferencesFragment.ReadingOrder.OLDEST_FIRST
...
import com.altayyar.app.presentation.ui.feature.timeline.toViewData
        ...
        viewModelScope.launch {
            try {
                ...
                timelineDao.insertHomeTimelineItem(
                    LoadMorePlaceholder(placeholderId, loading = true).toEntity(tayyarAccountId = accountId)
                )
