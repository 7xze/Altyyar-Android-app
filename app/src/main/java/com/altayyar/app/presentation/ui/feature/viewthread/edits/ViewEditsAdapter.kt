package com.altayyar.app.presentation.ui.feature.viewthread.edits
...
import com.altayyar.app.presentation.ui.adapter.PollAdapter
import com.altayyar.app.presentation.ui.adapter.PollAdapter.Companion.MULTIPLE
import com.altayyar.app.presentation.ui.adapter.PollAdapter.Companion.SINGLE
import com.altayyar.app.databinding.ItemStatusEditBinding
import com.altayyar.app.entity.Attachment.Focus
...
import com.altayyar.app.util.BlurhashDrawable
import com.altayyar.app.util.TayyarTagHandler
import com.altayyar.app.util.aspectRatios
 ...
 * deleted text.
 */
class EditsTagHandler(val context: Context) : TayyarTagHandler() {
    ...
    companion object {
        ...
        const val DELETED_TEXT_EL = "tayyar-del"

        /** XML element to represent text that has been inserted */
        // Can't be an element that Android's HTML parser recognises, otherwise the tagHandler
        // won't be called for it.
        const val INSERTED_TEXT_EL = "tayyar-ins"
    }
}
