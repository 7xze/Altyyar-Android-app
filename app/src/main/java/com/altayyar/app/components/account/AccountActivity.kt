...
package com.altayyar.app.components.account
...
import com.altayyar.app.BottomSheetActivity
import com.altayyar.app.EditProfileActivity
import com.altayyar.app.R
import com.altayyar.app.StatusListActivity
import com.altayyar.app.ViewMediaActivity
import com.altayyar.app.components.account.list.ListSelectionFragment
...
import com.altayyar.app.components.report.ReportActivity
import com.altayyar.app.databinding.ActivityAccountBinding
import com.altayyar.app.db.entity.AccountEntity
import com.altayyar.app.entity.Account
import com.altayyar.app.entity.Relationship
...
import com.altayyar.app.util.getDomain
...
import com.altayyar.app.view.showMuteAccountDialog
...
class AccountActivity : BottomSheetActivity(), ActionButtonActivity, MenuProvider, LinkListener {
    ...
    private fun updateBadges() {
        ...
        if (loadedAccount?.bot == true) {
            val badgeView =
                getBadge(
                    getColor(R.color.tayyar_grey_50),
    ...
    private fun onRelationshipChanged(relation: Relationship) {
        ...
        if (!viewModel.isSelf && followState == FollowState.FOLLOWING &&
            ...
            if (relation.notifying != null) {
                subscribing = relation.notifying == true
            } else if (relation.subscribing != null) {
                subscribing = relation.subscribing == true
            }
        }
