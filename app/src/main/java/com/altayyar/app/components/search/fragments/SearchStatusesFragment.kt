...
package com.altayyar.app.components.search.fragments
...
import com.altayyar.app.components.compose.ComposeActivity.ComposeOptions
import com.altayyar.app.components.report.ReportActivity
import com.altayyar.app.components.search.adapter.SearchStatusesAdapter
...
import com.altayyar.app.util.toDeletedStatusWithEditableText
                        ...
                        viewModel.deleteStatusAsync(id, false).await().fold(
                            { deletedStatus ->
                                ...
                                val redraftStatus = if (deletedStatus.isEmpty) {
                                    status.toDeletedStatusWithEditableText()
                                } else {
                                    deletedStatus
                                }
