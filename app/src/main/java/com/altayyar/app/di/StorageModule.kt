...
object StorageModule {
    ...
    fun providesDatabase(@ApplicationContext appContext: Context, converters: Converters): AppDatabase {
        return Room.databaseBuilder(appContext, AppDatabase::class.java, "tayyarDB")
            ...
            .addMigrations(
                ...
                AppDatabase.Migration25_26(appContext.getExternalFilesDir("Tayyar")),
                ...
                AppDatabase.MIGRATION_47_48, AppDatabase.MIGRATION_51_52, AppDatabase.MIGRATION_52_53,
                AppDatabase.MIGRATION_53_54, AppDatabase.MIGRATION_54_56, AppDatabase.MIGRATION_56_58,
                AppDatabase.MIGRATION_58_60, AppDatabase.MIGRATION_60_62, AppDatabase.MIGRATION_64_66,
                AppDatabase.MIGRATION_66_68, AppDatabase.MIGRATION_68_70
            )
            .build()
    }
}
