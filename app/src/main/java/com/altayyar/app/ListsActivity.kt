...
import com.altayyar.app.viewmodel.ListsViewModel
import com.altayyar.app.viewmodel.ListsViewModel.Event
import com.altayyar.app.viewmodel.ListsViewModel.LoadingState.ERROR_NETWORK
import com.altayyar.app.viewmodel.ListsViewModel.LoadingState.ERROR_OTHER
import com.altayyar.app.viewmodel.ListsViewModel.LoadingState.INITIAL
import com.altayyar.app.viewmodel.ListsViewModel.LoadingState.LOADED
import com.altayyar.app.viewmodel.ListsViewModel.LoadingState.LOADING
    ...
    private fun showlistNameDialog(list: MastoList?) {
        ...
        list?.let {
            if (it.exclusive == null) {
                ...
                binding.exclusiveCheckbox.isChecked = it.exclusive == true
            }
        }
    }
