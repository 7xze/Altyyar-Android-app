...
import com.altayyar.app.FakeSpannable
    ...
    companion object {
        ...
        fun data(): Iterable<Array<Any>> {
            return listOf(
                ...
                // urls can have balanced parenthesis, otherwise they are ignored https://github.com/altayyarapp/tayyar/issues/4425
                arrayOf("(https://en.wikipedia.org/wiki/Beethoven_(horse))", 25),
                // protocols can have any case https://github.com/altayyarapp/tayyar/issues/4641
