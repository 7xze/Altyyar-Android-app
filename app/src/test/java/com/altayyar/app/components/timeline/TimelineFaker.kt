...
fun fakeStatus(
    ...
    mentions = emptyList(),
    tags = emptyList(),
    application = Status.Application("تيار", "https://altayyar.app"),
    pinned = false,
    muted = false,
    poll = null,
    card = null,
...
suspend fun AppDatabase.insert(timelineItems: List<HomeTimelineData>, tayyarAccountId: Long = 1) = withTransaction {
...
suspend fun AppDatabase.assertTimeline(
    ...
    val pagingSource = timelineDao().getHomeTimeline(tayyarAccountId)
