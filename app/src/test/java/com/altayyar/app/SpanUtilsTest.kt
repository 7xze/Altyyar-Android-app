...
import com.altayyar.app.util.FoundMatchType
import com.altayyar.app.util.MENTION_PATTERN_STRING
import com.altayyar.app.util.PatternFinder
import com.altayyar.app.util.TAG_PATTERN_STRING
import com.altayyar.app.util.highlightSpans
import com.altayyar.app.util.twittertext.Regex
...
class SpanUtilsTest(
    ...
    companion object {
        ...
        fun data() = listOf(
            ...
            // case should be ignored on protocols https://github.com/altayyarapp/tayyar/issues/4641
